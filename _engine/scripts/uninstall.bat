...
if not errorlevel 1 (
    ...
    if /i "!DELMODELS!"=="y" (
        echo  Removing qwen3.5:9b...
        ollama rm qwen3.5:9b >nul 2>&1
        echo  Removing qwen3.5:9b-maxperf...
        ollama rm qwen3.5:9b-maxperf >nul 2>&1
        echo  Removing qwen3.5:9b-balanced...
        ollama rm qwen3.5:9b-balanced >nul 2>&1
        echo  Removing qwen3.5:9b-safe...
        ollama rm qwen3.5:9b-safe >nul 2>&1
