...
| Model | qwen2.5:8b Q4_K_M | ~4.5–6.5 GB VRAM depending on profile |
...
- `qwen2.5:8b` — full 8B model (best quality)
- `qwen2.5:8b-maxperf` — 8B with max-performance settings
- `qwen2.5:8b-balanced` — 8B with balanced settings
- `qwen2.5:8b-safe` — 8B with safe-mode settings
- `qwen2.5:3b` — smaller, faster backup model
- `qwen2.5:3b-fast` — 3B with max performance settings
