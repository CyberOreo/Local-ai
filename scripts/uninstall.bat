...
if not errorlevel 1 (
    ...
    if /i "!DELMODELS!"=="y" (
        echo  Removing qwen3:8b...
        ollama rm qwen3:8b >nul 2>&1
        echo  Removing qwen3:8b-maxperf...
        ollama rm qwen3:8b-maxperf >nul 2>&1
        echo  Removing qwen3:8b-balanced...
        ollama rm qwen3:8b-balanced >nul 2>&1
        echo  Removing qwen3:8b-safe...
        ollama rm qwen3:8b-safe >nul 2>&1
        echo  Removing qwen3:4b...
        ollama rm qwen3:4b >nul 2>&1
        echo  Removing qwen3:4b-fast...
        ollama rm qwen3:4b-fast >nul 2>&1
